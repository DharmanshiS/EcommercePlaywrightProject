...
test('Coupon is applied successfully', async ({ page }) => {
    ...
    expect(discount).toBeCloseTo(expectedDiscount, 2);  // Allow small rounding error
    ...
    expect(totalCost).toBeCloseTo(expectedTotal, 2);  // Allow small rounding error
